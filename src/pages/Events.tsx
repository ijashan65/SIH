...
const Events = () => {
  ...
  const handleCreateEvent = async (e) => {
    ...
    try {
      ...
      const { data, error } = await eventsApi.createEvent(eventData);
      if (error) throw error;
            ...
            <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Organize a networking event, workshop, or social gathering for the alumni community.
                  </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleCreateEvent} className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select 
                        value={newEvent.is_virtual ? "virtual" : "in-person"} 
                        onValueChange={(value) => setNewEvent(prev => ({ ...prev, is_virtual: value === "virtual" }))}
                      >
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewEvent(prev => newEvent.is_virtual 
                          ? ({ ...prev, meeting_link: e.target.value })
                          : ({ ...prev, location: e.target.value })
                        )}
                        placeholder={newEvent.is_virtual ? "https://zoom.us/..." : "Event venue"}
                        required
                      />
                    </div>
                    <div>
