...
const Opportunities = () => {
  ...
  const handleReferenceRequest = (jobId: number) => {
    if (!referenceRequests.includes(jobId)) {
      setReferenceRequests([...referenceRequests, jobId]);
      toast.success("Reference requested successfully!");
    } else {
      toast("Reference already requested");
    }
  };
